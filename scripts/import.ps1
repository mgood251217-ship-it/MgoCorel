...
if (Test-Path $ModulesPath) {
    $sourceFiles += Get-ChildItem $ModulesPath -File | Where-Object {
...
$moduleFiles = $sourceFiles | Where-Object {
    $_.Extension -in ".bas", ".cls"
}
...
$formFiles = $sourceFiles | Where-Object {
    $_.Extension -eq ".frm"
}
...
Write-Host "======================================" -ForegroundColor Green
Write-Host ""
Write-Host "MgoCorel berhasil di-import ke CorelDRAW."
Write-Host "GMS:"
Write-Host $gmsProject.FullFileName
Write-Host ""   